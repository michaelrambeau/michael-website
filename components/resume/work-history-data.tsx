export const workHistoryData = {
  ...
  bentoandco: {
    ...
    resp: "Development and maintenance of [shipandco.com](https://www.shipandco.com), a web application built on top of [Meteor](https://www.meteor.com/)",
    points: [
  ...
  firstserver: {
    title:
      "Web developer / UI-UX specialist at [FirstServer](https://www.firstserver.co.jp/milestones/)",
    from: "2014",
    to: "2016",
    duration: "18 months",
    location: "Osaka, Japan",
    resp: "Research and development about a Customer Portal web application UI/UX.",
    points: [
  ...
  airfrance: {
    ...
    resp: "In charge of the development and the maintenance of a pool of intranet web applications powered by Lotus Notes Domino.",
    points: [
